...
import { SignupInput } from "subhasahoocommon";
...
interface AuthProps {
  ...
  export const Auth = ({ type }: AuthProps): JSX.Element => {
    ...
    <div className="h-screen flex justify-center flex-col">
      <div className="flex justify-center">
        <div>
            ...
            <div className="pt-8">
                {type === "signup" ? <LabelledInput label="Username" placeholder="Subhasmita Sahoo" onChange= {(e) =>{
                    setpostInputs({
                        ...postInputs,
                        name: e.target.value
                    })
                ...
                <LabelledInput label="Email" placeholder="subha@gmail.com" onChange= {(e) =>{
                    setpostInputs({
                        ...postInputs,
                ...
                <LabelledInput label="Password" type={"password"} placeholder="Subha123" onChange= {(e) =>{
                    setpostInputs({
                        ...postInputs,
